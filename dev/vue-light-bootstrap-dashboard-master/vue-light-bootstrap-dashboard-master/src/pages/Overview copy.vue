        ...
        <div class="col-md-4">
          <card>
            <template slot="header">
              <h4 class="card-title" id="videoDesc">Local News</h4>
              <p class="card-category">In your area {{ newsSrc }}</p>
            </template>
                    <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
    <iframe id="newsVideo" class="embed-responsive-item" :src='videoSource' allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"  allowfullscreen></iframe>
...
export default {
  ...
  data() {
    return {
      videoSource: "https://www.youtube.com/embed/videoseries?list=PLAs1zSLtTHBTfvtHP89HpjoqoXNH9IZkF",
